...
case $OS in
  ...
  "apt")
	...
	apt-get update && apt-get -y install bspwm sxhkd rofi polybar ranger vim git mpd ncmpcpp
    ;;

  "pacman")
	pacman -Sy && pacman -S --noconfirm bspwm sxhkd rofi polybar ranger vim git mpd ncmpcpp
    ;;

  "yum")
	yum update && yum -y install bspwm sxhkd rofi polybar ranger vim git mpd ncmpcpp
    ;;

  "eopkg")
	eopkg update-repo && eopkg -y install git sxhkd rofi polybar ranger vim mpd ncmpcpp
    ;;

  "xbps")
	xbps-install -S && xbps-install -y bspwm sxhkd rofi polybar vim git mpd ncmpcpp
   ;;

  "apk")
	apk update && apk add bspwm sxhkd rofi polybar ranger vim git mpd ncmpcpp
    ;;

  "brew")
	brew upgrade && brew install bspwm sxhkd rofi polybar ranger vim git mpd ncmpcpp
    ;;
  ...
  "compile")
   ...
   "pkg")
	pkg upgrade && pkg install bspwm sxhkd rofi polybar ranger vim git mpd ncmpcpp
    ;;
    
   "dnf")
   	dnf upgrade && dnf install bspwm sxhkd rofi polybar ranger git mpd ncmpcpp
    ;;
    ...
    emerge --ask app-misc/mpd
    emerge --ask app-misc/ncmpcpp
    ;;
  *)
	clear
